    ...
    <div class="p-6">
      ...
      <form action="{{ route('responsible.events.update', $event->id) }}"
        ...
        <div class="md:col-span-2 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label for="status" class="block text-sm font-semibold text-primary mb-2">Status</label>
            ...
            <div class="flex items-center mt-6">
              ...
              <label for="certificated" class="ml-2 block text-sm text-primary font-medium">Certified Event</label>
            </div>
          </div>
        ...
        <div>
          ...
          <img id="posterPreview"
               ...
               alt="Event Poster"
               class="w-full h-auto rounded-lg border mb-4 shadow-sm">
          <input type="file"
                 id="poster"
                 name="poster"
                 accept="image/*"
