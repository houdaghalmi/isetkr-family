...
<body class="bg-gray-50 text-gray-900 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        <!-- Flash Messages -->
        @if(session('success'))
        <div class="mb-6 p-4 bg-primary/10 border border-primary text-primary rounded-lg flex items-center gap-2">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
            <h1 class="text-3xl font-bold text-primary">My Posts</h1>
            <a href="{{ route('responsible.posts.create') }}"
                class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition shadow-lg flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden">
                <!-- Image Slider -->
                <div class="slide-container h-64 bg-gray-200 relative rounded-t-2xl" data-post-id="{{ $post->id }}">
                ...
                <div class="p-6">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="text-sm font-semibold text-primary">{{ $post->club->name ?? 'Club Name' }}</span>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('responsible.posts.edit', $post->id) }}"
                            class="flex-1 bg-primary/10 text-primary py-2 px-4 rounded-lg hover:bg-primary/20 transition text-center font-medium flex items-center justify-center gap-2">
                        ...
                        <form action="{{ route('responsible.posts.destroy', $post->id) }}" method="POST"
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="w-full bg-red-100 text-red-700 py-2 px-4 rounded-lg hover:bg-red-200 transition font-medium flex items-center justify-center gap-2">
            ...
            <div class="col-span-full text-center py-16">
                <i class="fas fa-newspaper text-6xl text-primary/30 mb-6"></i>
                ...
                <a href="{{ route('responsible.posts.create') }}"
                    class="bg-primary text-white px-8 py-3 rounded-lg hover:bg-secondary transition shadow-lg flex items-center gap-2 justify-center">
